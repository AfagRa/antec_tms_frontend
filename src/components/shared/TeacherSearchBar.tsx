...
import { searchGlobal, initSearchCache, type GlobalSearchResult, type SearchResultType } from '../../utils/globalSearch';
...
export default function TeacherSearchBar() {
  ...
  const results = useMemo(() => searchGlobal(debouncedQuery), [debouncedQuery]);
