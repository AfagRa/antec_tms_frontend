            ...
            <table className="border-separate border-spacing-0 text-sm" style={{ minWidth: `${20 + 132 + visibleLessons.length * 270 + 80}px` }}>
              <thead>
                <tr>
                  ...
                  <th className="right-0 bg-slate-100 border-b border-l border-surface-dark/20 px-3 py-3 text-center font-semibold text-slate-700 text-xs uppercase tracking-wide min-w-[80px]">Ümumi %</th>
                </tr>
                <tr>
                  ...
                  <th className="right-0 bg-slate-100 border-b border-l border-surface-dark/20 px-3 py-1" />
                </tr>
                <tr>
                ...
                {students.map((student, index) => {
                  ...
                  return (
                    <tr key={student.id} className="hover:bg-surface-dark/30 transition-colors">
                      ...
                      <td className={`bg-slate-100 border-b border-l border-surface-dark/20 px-3 py-2 text-center font-semibold text-sm ${avgColor}`}>
                        {avg !== null ? `${avg}%` : '-'}
                      </td>
                    </tr>
                  )
