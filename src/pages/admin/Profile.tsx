      ...
      <div className="rounded-neu bg-surface shadow-neu-sm p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col">
            ...
            <input type="text" value={profile?.name ?? ''} readOnly className="rounded-neu-sm border border-surface-dark/20 bg-surface px-3 py-2 text-sm text-text-base opacity-60 cursor-not-allowed outline-none" />
          </div>
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-text-base/50 mb-1">Soyad</label>
            <input type="text" value={profile?.surname ?? ''} readOnly className="rounded-neu-sm border border-surface-dark/20 bg-surface px-3 py-2 text-sm text-text-base opacity-60 cursor-not-allowed outline-none" />
          </div>
          <div className="flex flex-col">
            <label className="text-xs font-semibold text-text-base/50 mb-1">Email</label>
            <input type="email" value={profile?.email ?? ''} readOnly className="rounded-neu-sm border border-surface-dark/20 bg-surface px-3 py-2 text-sm text-text-base opacity-60 cursor-not-allowed outline-none" />
          </div>
          <div className="flex flex-col">
          ...
          {[
            ...
            <div key={f.label} className="flex flex-col">
              ...
              <div className="relative">
                <input type={f.show ? 'text' : 'password'} value={f.val} onChange={(e) => f.setVal(e.target.value)}
